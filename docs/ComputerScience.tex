...
I am currently considering: Linked list and an array.% A comparison table is shown in Fig \ref{fig:Data structure table}.
...
\end{thebibliography}
\section{Evaluation}
I believe that the final program achieves the main objectives but work could be done to improve the stability
