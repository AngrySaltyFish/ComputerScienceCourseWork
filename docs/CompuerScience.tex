...
which is written in python. Due to it being written in python and my application writted in c++
it is difficult to interact betwen the two. One approach that I though about taking was to download
the videos with the youtube-dl windows execuatable. There are a couple of problems with this, the
first is that it is very slow due to it being compile from a python language making it not very pratical.
...
Since there is a possiblity that it will be running as part of a network on a school
computer I need to consider certain restrictions that will be put upon the program.
One obvious limitaion would be that the user is unlikely to have admin permissions
...
as possble as people may run different OSs at home and the school may transition to
...
nature of qt will make it flexiable with older systems.
...
\begin{figure}[H]
    \begin{tikzpicture}[node distance=6cm]
        ...
        \node (foundFalse) [startstop, right of=ifFound] {return a empty string};
...
\section{Testing}
In this section I will test my built application agaisnt the objectives that I originally stated and make sure
that my applications fulfills the purpose it is meant to.
...
\begin{figure}[H]
    \begin{center}
        \begin{tabular} { | c | c | c | c | c | c |}
            ...
            1               &Can type into the search bar and search   &      Normal            &       Pass       &                         \\ \hline
            2               &Tried to repeatedly search for a video    &      Errounous         &       Pass       &                         \\ \hline
                            &without the progress bar becomming messed &                        &                  &                         \\
                            &up                                        &                        &                  &                         \\ \hline
            3               &Preview a video and setting a different   &      Normal            &       N/A        &                         \\
                            &quality.                                  &                        &                  &                         \\ \hline
            4               &Able to download a video with the progress&      Normal            &       Pass       &                         \\
                            &bar being updated periodically.           &                        &                  &                         \\ \hline
            5               &Download a video with multiple special    &      Normal            &       Pass       &                         \\
                            &characters in it.                         &                        &                  &                         \\ \hline
            6               &Able to switch entries in the database    &      Normal            &       Pass       &                         \\
                            &with one another.                         &                        &                  &                         \\ \hline
            7               &Able to delete items in playlists and     &      Normal            &       N/A        &                         \\
                            &remove them from the database             &                        &                  &                         \\ \hline
            8               &Buttons do not raise an error in any state&      Erroneous         &       Fail       &                         \\ \hline
            9               &The burning process runs on linux without &      Erroneous         &       Fail       &                         \\
                            &permission errors.                        &                        &                  &                         \\ \hline
            10              &The burning process works on windows      &      Erroneous         &       Pass       &                         \\
