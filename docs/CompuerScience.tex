...
suggestests the preview is to allow the user to view the video before downloading while.\\
...
With this knowledge I start to explain the different classes that I will be using and 
how they will interact with one another the figures (\ref{fig:PlayWindow class layout} - 
\ref{fig:DatabaseHandler class layout}) give a breif description of each class and how
they work. The final figure \ref{}
